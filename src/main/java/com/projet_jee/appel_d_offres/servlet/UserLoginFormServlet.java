...
public class UserLoginFormServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<title>Connexion d'utilisateur</title>");
        out.println("<style>");
        out.println("body {");
        ...
        out.println("</head>");
        out.println("<body>");
        out.println("<form action='" + request.getContextPath() + "/webapi/users/login' method='post'>");
        out.println("<h2>Connexion d'utilisateur</h2>");
        out.println("<div>");
        ...
        out.println("</div><a href='/appel-d-offres/UserSignUpFormServlet'>S'inscrire</div>");
        out.println("</div>");
        out.println("</form>");
        out.println("</body>");
        out.println("</html>");
