...
public class AddUserFormServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("</head>");
        out.println("<body>");
        out.println("<form action='" + request.getContextPath() + "/webapi/users/add' method='post'>");
        out.println("<h2>Ajouter un utilisateur</h2>");
        out.println("<div>");
        out.println("<label for='username'>nom d'utiilisateur:</label>");
