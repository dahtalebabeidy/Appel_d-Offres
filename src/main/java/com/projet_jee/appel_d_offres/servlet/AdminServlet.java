...
public class AdminServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("    <button class='dashboard-button'><a href='/appel-d-offres/AddUserFormServlet'>Ajouter Un AO</a></button>");
//        out.println("    <button class='dashboard-button'><a href='extendAOForm'>Prolonger La date d'un AO</a></button>");
