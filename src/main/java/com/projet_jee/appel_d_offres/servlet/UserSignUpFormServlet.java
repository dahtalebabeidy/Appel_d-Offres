...
/**
 * Servlet implementation class UserSignUpFormServlet
 */
public class UserSignUpFormServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public UserSignUpFormServlet() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<title>Inscription d'utilisateur</title>");
        out.println("<style>");
        out.println("body {");
        ...
        out.println("</head>");
        out.println("<body>");
        out.println("<form action='" + request.getContextPath() + "/webapi/users/signup' method='post'>");
        out.println("<h2>Inscription d'utilisateur</h2>");
        out.println("<div>");
