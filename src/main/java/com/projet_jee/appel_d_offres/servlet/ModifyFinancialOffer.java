...
/**
 * Servlet implementation class ModifyFinancialOffer
 */
public class ModifyFinancialOffer extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public ModifyFinancialOffer() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<title>Modifier L'offre Financiere</title>");
	    out.println("<style>");
	    out.println("    body {");
	    ...
	    out.println("</head>");
	    out.println("<body>");
	    out.println("    <form action='" + request.getContextPath() + "/webapi/submission/modifyFinancialOffer' method=\"post\">");
	    out.println("        <h2>Modifier l'offre financière</h2>");
	    out.println("        <div>");
	    ...
	    out.println("        </div>");
	    out.println("        <div>");
	    out.println("            <label for=\"newFinancialOffer\">Nouvelle offre financière :</label>");
	    out.println("            <input type=\"number\" name=\"newFinancialOffer\" required>");
	    out.println("        </div>");
	    out.println("        <div>");
