...
/**
 * Servlet implementation class ExtendAOForm
 */
public class ExtendAOForm extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<title>Prolonger la date limite d'un AO</title>");
        out.println("<style>");
        out.println("body {");
        ...
        out.println("</head>");
        out.println("<body>");
        out.println("<form action='" + request.getContextPath() + "/webapi/ao/extend' method='post'>");
        out.println("<h2>Prolonger la date limite d'un AO</h2>");
        out.println("<div>");
        out.println("<label for=\"aoName\">Nom de l'AO:</label>");
        out.println("<input type=\"text\" id=\"aoName\" name=\"aoName\" required>");
        out.println("</div>");
        out.println("<div>");
        out.println("<label for=\"newDeadline\">Nouvelle date limite:</label>");
        out.println("<input type=\"date\" id=\"newDeadline\" name=\"newDeadline\" required>");
        out.println("</div>");
        out.println("");
        out.println("<div>");
        out.println("<input type='submit' value='Prolonger'>");
        out.println("</div>");
        out.println("</form>");
        out.println("</body>");
        out.println("</html>");
